    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-danger"><small>This action cannot be undone and will also delete all associated events and images.</small></p>
            </div>
...
function confirmDelete(categoryId, categoryName) {
    ...
    document.getElementById('deleteForm').action = '{{ url("admin/portfolio/categories") }}/' + categoryId;
...
$(document).ready(function() {
    ...
    $(document).on('click', '.delete-category', function() {
        ...
        const categoryName = button.data('name') || 'this category';
