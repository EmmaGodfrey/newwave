...
@section('title') Add Service Pricing @endsection
                ...
                <h4 class="card-title mb-4">Service Information</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="price" class="form-label">Price in Zambian kwacha <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('price_label') is-invalid @enderror" 
                                   id="price_label" name="price_label" value="{{ old('price_label') }}" 
