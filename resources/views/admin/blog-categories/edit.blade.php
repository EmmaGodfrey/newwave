            ...
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <p class="card-title-desc">Update category details</p>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                       id="sort_order" name="sort_order" value="{{ old('sort_order', $blogCategory->sort_order) }}">
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="alert alert-info">
                                <strong>{{ $blogCategory->blogs()->count() }}</strong> blog post(s) in this category
                            </div>
                        </div>
                    </div>
                </div>
