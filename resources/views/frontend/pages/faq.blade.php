...
<!-- Mirrored from duruthemes.com/demo/html/gloom/dark/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jan 2026 11:04:43 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><span class="rolling-text">Pages</span> <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="faq.html" class="dropdown-item active"><span>FAQs</span></a></li>
                ...
                <div class="col-lg-10 col-md-12">
                    <ul class="accordion-box clearfix">
                        <li class="accordion block">
                            <div class="acc-btn"><span class="count">1.</span> What are your wedding photography prices?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Photography viverra tristique justo duis vitae diam neque nivamus aestan ateuene artines miss atelit finibus viverra nec lacus. Nedana drana erodino setlie suscipe no tristique.</div>
                                </div>
                            </div>
                        </li>
                        <li class="accordion block">
                            <div class="acc-btn"><span class="count">2.</span> How long does a photo session take?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Photography viverra tristique justo duis vitae diam neque nivamus aestan ateuene artines miss atelit finibus viverra nec lacus. Nedana drana erodino setlie suscipe no tristique.</div>
                                </div>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn"><span class="count">3.</span> When will we receive the photos?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Photography viverra tristique justo duis vitae diam neque nivamus aestan ateuene artines miss atelit finibus viverra nec lacus. Nedana drana erodino setlie suscipe no tristique.</div>
                                </div>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn"><span class="count">4.</span> What happens if the weather is bad on the shoot day?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Photography viverra tristique justo duis vitae diam neque nivamus aestan ateuene artines miss atelit finibus viverra nec lacus. Nedana drana erodino setlie suscipe no tristique.</div>
                                </div>
                        ...
                        <li class="accordion block">
                            <div class="acc-btn"><span class="count">5.</span> Do you offer album or print services?</div>
                            <div class="acc-content">
                                <div class="content">
                                    <div class="text">Photography viverra tristique justo duis vitae diam neque nivamus aestan ateuene artines miss atelit finibus viverra nec lacus. Nedana drana erodino setlie suscipe no tristique.</div>
                                </div>
    ...
    <footer class="footer-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-12"><a href="index.html"><img src="images/logo-light.png" alt=""></a></div>
