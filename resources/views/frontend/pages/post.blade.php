...
<section class="section-padding post-page">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6"> <img src="images/slider/03.jpg" class="br-5px mb-60 img-fluid" alt="" loading="lazy">
            </div>
            <div class="col-md-6">
                <div class="video-gallery mb-60">
                    <div class="item">
                        <div class="img"> <img src="images/slider/09.jpg" alt=""> </div>
                        <a class="vid" href="https://youtu.be/z2VnmY5jK_s"> <span class="video-icon"> <i
                                    class="fa-solid fa-play"></i></span> </a>
                    </div>
                </div>
            </div>
        </div>
        <p>Quisque volutpat non nisl idele tincidunt praesent at eros vitae the pulvinar ornare. Nuncion eleifen the
            interdum velit, ac accumsan dui fermentum et. In the imperdiet urna sed efficitur euismod. Vestibulum bullam
            corper purus arcu, vel pretium nibh mattis vestibulum ac diam purus. Quisque volutpat non nisl idele
            tincidunt praesent at eros vitae the pulvinar ornare. Nuncion eleifen the interdum velit, ac accumsan dui
            fermentum.</p>
        <p>Quisque volutpat non nisl idele tincidunt praesent at eros vitae the pulvinar ornare. Nuncion eleifen the
            interdum velit, ac accumsan dui fermentum et. In the imperdiet urna sed efficitur euismod. Vestibulum bullam
            corper purus arcu, vel pretium nibh mattis vestibulum ac diam purus.</p>
                ...
                <div class="col-md-6">
                    <div class="blog-post-comment-wrap">
                        ...
                        <div class="blog-post-user-content">
                            ...
                            <p>Design in the ultricies nibh non dolor maximus miss inte duru faubs neque nec tincidunte
                                aliquam eraten fermen. </p>
                        </div>
                    </div>
                </div>
                <!-- Contact Form -->
                <div class="col-md-5 offset-md-1">
                    ...
                    <form method="post" class="contact__form" action="#">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <textarea name="message" id="message" cols="30" rows="4" placeholder="Your Comment *"
                                    required></textarea>
                            </div>
                            <div class="col-md-12">
                                <div class="btn-wrap">
                                    <div class="btn-link">
                                        <input type="submit" value="Send Comment"> <span
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="prv">
                    <div class="img bg-img" data-background="images/slider/01.jpg">
                        <div class="text-left ontop">
                            <h5><a href="post.html">The Art of Style</a></h5> <span class="sub-title mb-0 mt-10">Prev
                                Post</span>
                        </div>
            ...
            <div class="col-md-2 text-center rest">
                <a href="blog.html" class="all-works d-flex align-items-center"> <span
                        class="icon full-width ti-layout-grid3"></span> </a>
            </div>
            <div class="col-md-5 rest">
                <div class="nxt">
                    <div class="img bg-img" data-background="images/slider/02.jpg">
                        <div class="text-right ontop">
                            <h5><a href="portfolio-page.html">Through the Creative Lens</a></h5> <span
                                class="sub-title mb-0 mt-10">Next Post</span>
                        </div>
                        <div class="overly"></div>
                    </div>
                </div>
